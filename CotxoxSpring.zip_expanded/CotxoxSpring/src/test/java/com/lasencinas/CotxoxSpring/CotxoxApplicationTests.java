...
import com.lasencinas.CotxoxSpring.service.CarreraService;
import com.lasencinas.CotxoxSpring.service.ConductorService;
...
public class CotxoxApplicationTests {
	...
	public void test_save_carrera() {
		...
		// seria necessari afegir el conductor però anem a testear primer com.lasencinas.CotxoxSpring.repo
...
//		Long idCarrera = carreraService.crearCarrera("1234567890123456", "Parc de Ses Estacions", "Festival Park", 15, 18);
//		// seria necesario añadir el conductor pero vamos a testear primero com.lasencinas.CotxoxSpring.repo
//		Assert.assertEquals("1234567890123456", carreraService.recuperaCarrera(idCarrera).getTarjetaCredito());
//	
